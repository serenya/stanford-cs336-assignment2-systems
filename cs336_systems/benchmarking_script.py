...
if __name__ == "__main__":
    ...
    results.append(run_basics_transformer_model(size="2.7B", context_length=512, d_model=2560, d_ff=10240, num_layers=32, num_heads=32, w_num_steps = 5, num_steps = 10, use_autocast=True))
